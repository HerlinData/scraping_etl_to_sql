...
fechacompleta = fecha_hora + timedelta(seconds=60)
df_filt_con_inicio_call = df[(df['hora_inicio_call_center'].notna())]
df_filt_con_inicio_call['hora_fin_call_center'] = df_filt_con_inicio_call['hora_fin_call_center'].fillna(fechacompleta)
###############
